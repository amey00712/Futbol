...
/*BubbleBottomBarItem tab(IconData icon, String tabName) {
  return BubbleBottomBarItem(
      ...
      title: AutoSizeText(
        tabName,
        style: TextStyle(fontSize: textSizeMedium, fontFamily: fontMedium, color: Colors.white),
        maxLines: 1,
      ));
} */

BubbleBottomBarItem tab(String icon, String tabName) {
  return BubbleBottomBarItem(
      backgroundColor: Colors.white,
      icon:  Image.asset(icon,color: Colors.white,height: 22,),
      activeIcon: Image.asset(icon,color: Colors.white,height: 22,),
      title: AutoSizeText(
        tabName,
        style: TextStyle(fontSize: textSizeMedium, fontFamily: fontMedium, color: Colors.white),
        maxLines: 1,
